...
import org.polymap.p4.data.importer.osm.Osmformat.PrimitiveGroup;
import org.polymap.p4.data.importer.osm.Osmformat.StringTable;

/**
 * This class uses {@link org.polymap.p4.data.importer.osm.Fileformat} and
 * {@link org.polymap.p4.data.importer.osm.Osmformat}, who where generated out of
...
class OsmPbfFeatureIterator
    ...
    private boolean handleDenseNodes( org.polymap.p4.data.importer.osm.Osmformat.DenseNodes nodes,
    ...
    private boolean handleDenseNode( org.polymap.p4.data.importer.osm.Osmformat.DenseNodes nodes, boolean countMode,
            int denseNodesIndex ) {
        String key;
        String value;
